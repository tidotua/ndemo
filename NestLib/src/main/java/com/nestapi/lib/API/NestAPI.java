...
public final class NestAPI implements ValueEventListener {
    ...
    public void unAuthenticate(final CompletionListener listener) {
        Log.v(TAG, "unauthenticating");
        mFirebaseRef.unauth(new Firebase.CompletionListener() {
            @Override
            public void onComplete(FirebaseError firebaseError, Firebase firebase) {
                if (null != listener) {
                    if (null == firebaseError) {
                        ...
                        listener.onError(firebaseError.getCode());
                    }
                }
            }
        });
